...
/*
GetHealthzOK operator is healthy
...
/*
GetHealthzInternalServerError operator is not healthy
...
/*
GetHealthzNotImplemented operator healthy data is not retrievable
