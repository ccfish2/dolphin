...
// DeleteRecorderIDParams contains all the bound params for the delete recorder ID operation
...
func (o *DeleteRecorderIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
