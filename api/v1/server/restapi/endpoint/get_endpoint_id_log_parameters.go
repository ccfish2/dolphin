...
// GetEndpointIDLogParams contains all the bound params for the get endpoint ID log operation
...
func (o *GetEndpointIDLogParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
