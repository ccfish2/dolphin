...
// PatchEndpointIDParams contains all the bound params for the patch endpoint ID operation
...
func (o *PatchEndpointIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
