...
func configureAPI(api *restapi.CiliumAPIAPI) http.Handler {
	...
	if api.StatedbGetStatedbDumpHandler == nil {
		api.StatedbGetStatedbDumpHandler = statedb.GetStatedbDumpHandlerFunc(func(params statedb.GetStatedbDumpParams) middleware.Responder {
			return middleware.NotImplemented("operation statedb.GetStatedbDump has not yet been implemented")
		})
	}
	if api.StatedbGetStatedbQueryTableHandler == nil {
		api.StatedbGetStatedbQueryTableHandler = statedb.GetStatedbQueryTableHandlerFunc(func(params statedb.GetStatedbQueryTableParams) middleware.Responder {
